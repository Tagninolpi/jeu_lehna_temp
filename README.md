...
```
cd existing_repo
git remote add origin https://gitlab-pedago.univ-lyon1.fr/cpalandre/jeu_lehna.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-pedago.univ-lyon1.fr/cpalandre/jeu_lehna/-/settings/integrations)
